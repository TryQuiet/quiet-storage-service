...
/* eslint-disable @typescript-eslint/restrict-template-expressions -- ignore */
/* eslint-disable @typescript-eslint/no-unnecessary-condition -- ignore */
/* eslint-disable complexity -- ignore */
/* eslint-disable @typescript-eslint/strict-boolean-expressions -- ignore */
...
export default createPrompt(
  <ActionValue, Value>(
    ...
    const helpTip = config.actions
      .map(
        action =>
          `${theme.style.help(action.name)} ${theme.style.key(action.key.toUpperCase())}`,
      )
      .join(' ')
